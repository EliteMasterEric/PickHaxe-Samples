...
class ModItems {
    ...
    // Item Groups
    public static final ITEM_GROUP:ResourceKey<CreativeModeTab> = ResourceKey.create(Registries.CREATIVE_MODE_TAB,  new ResourceLocation(MadeInHaxeMod.MOD_ID, "glyph_haxe"));
